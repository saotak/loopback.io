...
"magna aliqua."
    ...
    <tr>
      ...
      <td>
        <strong>For auto-migrate usage</strong>. Set it to <code>false</code> when it's needed to auto-generated non-default type property values. e.g To use <code>"uuid"</code> as the id property, the id <code>type</code> should set to string, <code>generated</code> should set to true, and this field should set to false. Please check connectors' the <code>README</code> file for more information about auto-migration / auto-update.
      </td>
    </tr>
    <tr>
      <td>*</td>
